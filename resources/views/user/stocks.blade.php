            ...
            <thead>
                ...
                <tr class="border-y-2">
                    ...
                    <td class="text-[#6D6D6D] text-start py-2">
                        <form action="{{ route('user.add-stock', $product->id) }}" method="POST" class="flex items-center gap-2">
                            @csrf
                    ...
                    <td class="text-[#6D6D6D] text-start py-2">
                        <form action="{{  route('user.reduce-stock', $product->id) }}" method="POST" class="flex items-center gap-2">
                            @csrf
