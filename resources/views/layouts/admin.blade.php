                ...
                <div class="flex flex-col gap-5">
                    ...
                    <a href="{{route('admin.staf')}}">
                        <div class="{{ $staf ? 'bg-[#ECF3FF]' : 'bg-white' }} flex items-center gap-6 p-3 rounded-md hover:bg-[#ECF3FF] duration-500 ease-in-out group ">
                            ...
                            <div class="w-6 h-6"></div>
                            <h3 class="{{ $staf ? 'text-[#465FFF]' : 'text-[#6D6D6D]' }} text-xl font-semibold group-hover:text-[#465FFF]">Staf</h3>
                        </div>
                    </a>
                </div>
            </div>
        ...
        <div class="ml-[347px]">
            <div class="flex justify-end w-full py-5 px-10 border-b-2">
                <div class="flex items-center gap-1">
                    ...
                    <h3 class="text-xl font-semibold group-hover:text-[#465FFF] text-[#6D6D6D]">{{ Auth::user()->name }}</h3>
                </div>
            </div>
            <div class="bg-[#F9FAFB] min-h-[calc(100vh-82px)] px-28 py-10 flex justify-center items-start">
                @yield('content')
            </div>
        </div>
    </div>
